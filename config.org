...
** TCL
Most of the widely used EDA tools all support scripting using the Tool Command
Language.
#+BEGIN_SRC emacs-lisp
...
#+END_SRC
** Multiple Cursors
One of my coworkers uses Sublime, which allows one to simultaneously edit
similar lines.  Software developers might not really find this very useful, but
for FPGA and ASIC designers, this is a huge productivity boost.
#+BEGIN_SRC emacs-lisp

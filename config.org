...
path and that it is made executable.  Note that this script points at the Vivado
installation tree.  The `-I` switch allows for the resolution of Xilinx
primitives, which is pretty awesome.
#+BEGIN_SRC shell
#!/bin/bash
exec /usr/bin/verilator -I /opt/Xilinx/Vivado/2017.1/data/ "$@"
#+END_SRC
